# This reward function is (critic score, format score)
...
def compute_score(data_source:str, solution_str:str, ground_truth, extra_info=None, timeout_score=0.0) -> bool:
    ...
    reveiews = extra_info.get("reviews", 1)
    workers = 1
    ...
    reward["general_score"] = general_verify(data_source, solution_str, ground_truth)
    reward["true_score"]=true_score
    reward["TP"]=0
    reward["FP"]=0
    reward["TN"]=0
    reward["FN"]=0
    reward["process_keys"]=["TP","TN","FP","FN","true_score", "general_score"]
